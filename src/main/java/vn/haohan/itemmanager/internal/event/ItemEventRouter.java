package vn.haohan.itemmanager.internal.event;

import vn.haohan.itemmanager.api.item.*;
 ...
 * <p>Flow:
 * <pre>
 * PlayerInteractEvent → HaoHanItemManager → Item ID → ItemDefinition → ItemBehavior.onUse()
 * </pre>
 */
public final class ItemEventRouter implements Listener {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (item != null) {
            vn.haohan.itemmanager.api.HaoHanItemManager.get().getItemService().validateAndUpdate(item);
        }
        ItemStack cursor = event.getCursor();
        if (cursor != null) {
            vn.haohan.itemmanager.api.HaoHanItemManager.get().getItemService().validateAndUpdate(cursor);
        }
    ...
    public void onPlayerJoin(org.bukkit.event.player.PlayerJoinEvent event) {
        ...
        for (ItemStack armor : player.getInventory().getArmorContents()) {
            if (armor != null) {
                vn.haohan.itemmanager.api.HaoHanItemManager.get().getItemService().validateAndUpdate(armor);
            }
        }
    }
    ...
    public void onPrepareItemCraft(org.bukkit.event.inventory.PrepareItemCraftEvent event) {
        ...
        if (result != null) {
            vn.haohan.itemmanager.api.HaoHanItemManager.get().getItemService().validateAndUpdate(result);
        }
    }
}
