package vn.haohan.itemmanager.internal.command;
...
/**
 * Command handler cho /im (Item Manager).
 * 
 * <p>Sub-commands:
 * <ul>
 ...
 * </ul>
 */
public final class ItemManagerCommand implements BasicCommand {
    ...
    public ItemManagerCommand(ItemRegistry itemRegistry, ItemService itemService,
    ...
    private boolean handleReload(CommandSender sender) {
        ...
        sender.sendMessage(Component.text("Reloading HaoHanItemManager...", NamedTextColor.YELLOW));
        reloadCallback.run();
        sender.sendMessage(Component.text("HaoHanItemManager reloaded! Items: " + itemRegistry.size() +
    ...
    private void sendHelp(CommandSender sender) {
        sender.sendMessage(Component.text(""));
        sender.sendMessage(Component.text("━━━ HaoHanItemManager Commands ━━━", NamedTextColor.GOLD, TextDecoration.BOLD));
