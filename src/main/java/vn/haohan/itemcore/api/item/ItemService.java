 ...
 * <pre>
 * // Tạo item
 * ItemStack item = HaoHanItemCore.get().getItemService().create("magic:fire_crystal", 4);
 * 
 * // Kiểm tra item
 * boolean isCrystal = HaoHanItemCore.get().getItemService().isItem(item, "magic:fire_crystal");
 * 
 * // Lấy ID
...
public interface ItemService {
    ...
    /** Access per-stack state such as custom durability and upgrade level. */
